...
- **История заказов** у каждого клиента: номер (у каждого клиента своя нумерация с 1), дата, название, статус («в разработке», «в производстве», «готово»), себестоимость и конечная цена.
...
- **Заказы в производство** — заказ можно разбить на несколько (12-1, 12-2…): у каждого свой изготовитель, номер в производстве, даты отправки и готовности, список материалов с отметкой «готов» и свой цвет, которым он подсвечивается и в списке материалов. Новый заказ у нужного изготовителя создаётся прямо из списка «Производство».
